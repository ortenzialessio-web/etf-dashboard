...
<style>
    ...
    html, body, [class*="css"], .stApp {
        font-family: 'Outfit', sans-serif;
            ...
            /* Sfondo verde per l'intera app */
.stApp {
    background-color: #162E2A;
}

/* Sfondo verde anche per la sidebar */
[data-testid="stSidebar"] {
    ...
    /* Campi di input (ticker, password, selectbox): testo nero,
       perché lo sfondo del widget resta chiaro ed è illeggibile in bianco */
...
def check_password():
    ...
    st.markdown("<p style='color:#CBD5E0 !important; font-size:0.9rem;'>Questa dashboard è privata. Inserisci la password per continuare.</p>", unsafe_allow_html=True)
